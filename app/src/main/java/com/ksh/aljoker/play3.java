...
public class play3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpnStart = findViewById(R.id.button_start_vpn3);
    ...
    File filePathxx = new File(Environment.getExternalStorageDirectory(), "/storage/emulated/0/Aljoker/vn/libUE4.so");
    File filePathx = new File(Environment.getExternalStorageDirectory(), "/storage/emulated/0/Android/data/delete/vn/Modded/libUE4.so");
    View.OnClickListener myListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {

            if (view == mButton1){
                Shell.SU.run("sh /storage/emulated/0/Android/data/delete/vn/ON.sh");
                if (!filePathx.exists()){
            ...
            if (view == mButton2){
                //Phone/Global/off
                Shell.SU.run("sh /storage/emulated/0/Android/data/delete/vn/OFF.sh");
                mtextview.setText("تم تعطيل الحمايه  ");
                mtextview.setTextColor(Color.RED);
            }
            if (view == mButton3){
                //Phone/Global/off
                Shell.SU.run("sh /storage/emulated/0/Android/data/delete/vn/FIX.sh");
