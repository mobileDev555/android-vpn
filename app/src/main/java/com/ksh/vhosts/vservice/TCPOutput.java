...
import com.ksh.vhosts.vservice.Packet.TCPHeader;
import com.ksh.vhosts.vservice.TCB.TCBStatus;
...
public class TCPOutput implements Runnable
{
    ...
    public TCPOutput(ConcurrentLinkedQueue<Packet> inputQueue, ConcurrentLinkedQueue<ByteBuffer> outputQueue,
                     Selector selector,ReentrantLock tcpSelectorLock, com.ksh.vhosts.vservice.VhostsService vpnService)
    {
