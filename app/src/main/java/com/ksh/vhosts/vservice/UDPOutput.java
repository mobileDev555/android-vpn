...
package com.ksh.vhosts.vservice;
...
public class UDPOutput implements Runnable
{
    ...
    private com.ksh.vhosts.vservice.VhostsService vpnService;
    ...
    public UDPOutput(ConcurrentLinkedQueue<Packet> inputQueue,ConcurrentLinkedQueue<ByteBuffer> outputQueue, Selector selector,ReentrantLock udpSelectorLock, com.ksh.vhosts.vservice.VhostsService vpnService)
    {
